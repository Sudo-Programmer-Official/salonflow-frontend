...
.queue-card .queue-action-btn.el-button--primary {
  background: var(--sf-primary, #0ea5e9) !important;
  color: #ffffff !important;
  border: 1px solid color-mix(in srgb, var(--sf-primary, #0ea5e9) 60%, #fff) !important;
}
.queue-card .meta {
  font-size: 0.85rem;
  opacity: 0.75;
